  ...
  return (
    <div className="facts_container">
      <div className="environmental_container_info">
        <h1 className="environmental_container_title">
      ...
      <div className="environmental_cards_container">
        <div className="environmental_card_01 displace_positive_top">
        ...
        <div className="environmental_card_02 displace_negative_top">
        ...
        <div className="environmental_card_03 displace_positive_top">
        ...
        <div className="environmental_card_04 displace_negative_top">
