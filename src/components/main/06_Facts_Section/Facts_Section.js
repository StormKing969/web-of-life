  ...
  return (
    <div className="facts_container">
      <div className="container_info">
        <h1 className="container_title">Fun Facts About The Environment</h1>
      ...
      <div className="environmental_cards_container">
        <div className="environmental_card_01">
          <div className="card_info color_grey">
            <p className="content">{Data[0].Fact}</p>
          </div>
        ...
        <div className="environmental_card_02">
          <div className="card_info color_green">
            <p className="content">{Data[1].Fact}</p>
          </div>
          <div className="card_img">
        ...
        <div className="environmental_card_03">
          <div className="card_info color_brown">
            <p className="content">{Data[2].Fact}</p>
          </div>
          <div className="card_img">
        ...
        <div className="environmental_card_04">
          <div className="card_info color_blue">
            <p className="content">{Data[3].Fact}</p>
          </div>
          <div className="card_img">
            <img src={Oil} alt="oil" />
          </div>
